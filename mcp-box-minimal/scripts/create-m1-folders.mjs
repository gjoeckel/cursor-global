...
// Version: 1.0.0
/**
 * Create M1 folder structure in Box (Proposal A).
 * Under M1 folder: one folder per activity ID; under each, Au, Ai, Ae, Pr.
 *
 * Run from cursor-ops:
 *   source config/box.env && node mcp-box-minimal/scripts/create-m1-folders.mjs
 *
...
const ACTIVITY_IDS = ['1-1-1', '1-1-2', '1-2-1', '1-2-2', '1-2-3', '1-3-1', '1-3-2', '1-5-1', '1-5-2', '1-5-3'];
...
async function main() {
  ...
  console.log('Creating', ACTIVITY_IDS.length, 'activity folders, each with Au, Ai, Ae, Pr...\n');
